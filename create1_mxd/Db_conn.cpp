...
bool Db_conn::initDB(string host,string user,string passwd,string db_name,int port)
{
    ...
    if(mysql == NULL)
    {
        cout << "Error: " << mysql_error(mysql)<<"1";
...
bool Db_conn::exeSQL(string sql)
{
...
list<char*> Db_conn:: exeSQL2(string sql)
